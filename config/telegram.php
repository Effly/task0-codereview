    ...
    'bots'                         => [
        'bot' => [
            ...
            'commands'            => [
                ...
                '/getShortLink' => App\Telegram\Commands\getShortLink::class,
                '/getInfoByLink' => App\Telegram\Commands\getInfoByLink::class,
                '/getStats' => App\Telegram\Commands\getStats::class,
            ],
        ],
